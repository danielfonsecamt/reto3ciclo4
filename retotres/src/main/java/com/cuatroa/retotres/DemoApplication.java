    ...
    public void run(String... args) throws Exception {
       ...
       SimpleDateFormat ft = new SimpleDateFormat("yyyy-MM-dd");
        ...
        crudRepository.saveAll(List.of(
                new Accessory("AP-903", "ACME", "PRESENTACION 1", "DESCRIPCION DETALLADA", 120000, true, 10, "https://www.avasoluciones.com/uploads/2021/09/910-006127.jpg"),
                new Accessory("AP-904", "ACME", "PRESENTACION 2", "DESCRIPCION DETALLADA",  130000, true, 10, "https://www.avasoluciones.com/uploads/2021/09/910-007.jpg")
        ));
